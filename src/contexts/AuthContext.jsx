...
export default function  AuthContextProvider({children}){
            ...
            try {
                ...
                if (solana) {
                    if (solana.isPhantom) {
                        ...
                        const res = await AccountService.findUser(response.publicKey.toString())
                        // console.log(res)
    ...
    return(
        <AuthContext.Provider value={{walletAddress,addWalletAddress,loadingConnection:loading,user}}>
        {children}
