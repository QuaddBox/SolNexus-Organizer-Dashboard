...
import { FileButton, Textarea, TextInput } from "@mantine/core";
				...
				<main className="createEvent">
					...
					<form action="" className="form" onSubmit={handleSubmit(submitData)}>
						<div className="form__container">
							...
							<hr className="line" />
							<section className="form__inputSection">
								<header className="form__inputSection__price">
									<h1 className="text-gray-600">Price (optional)</h1>
									<TextInput
										leftSection={<TbCurrencySolana color="purple" />}
										size="lg"
										type="number"
									/>
								</header>
