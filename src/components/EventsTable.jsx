            ...
            .map((event) => {
              return (
                <tr>
                  <td className="event">
                    <div className="date">
                      <p>{getMonthString(new Date(event.eventStarts.seconds * 1000).getMonth())}</p>
                      <span>{new Date(event.eventStarts.seconds * 1000).getDate()}</span>
                    </div>
                    ...
                    <div className="eventInfo">
                      ...
                      <p>{event.eventType}</p>
                      <p>{new Date(props.eventStarts.seconds * 1000).toString()}</p>
                    </div>
                  </td>
                  <td className="sold">
                    <p>
                  ...
                  <td className="gross">
                    <p>{event.ticketsSold.length * event.pricePerTicket} SOL</p>
                  </td>
                  {/* <td className="status">
              <p>Draft</p>
            </td> */}
